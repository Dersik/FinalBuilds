...
$query = "SELECT `id`,`latitude`,`longitude` FROM `events` WHERE `cityName` is Null OR `stateName` is NULL OR `cityName` = '' OR `stateName` = '' LIMIT 100";
