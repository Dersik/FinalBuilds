...
if(isset($_POST['formSubmit']) ){
	$varActorN = $_post['ActorN'];
	$varDirectorN = $_post['DirectorN'];
	$varActorBirth = $_post['ActorBirth'];
	$varDirectorBirth = $_post['DirectorBirth'];
	$varMovieT = $_post['MovieT'];
	$varRelease = $_post['Release'];
	$varMovieRating = $_post['MovieRating'];
