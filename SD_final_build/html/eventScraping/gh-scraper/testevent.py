...
def run(page_url):
    ...
    html_page = js2html.run(url=page_url, to_file=False, driver=browser, delay=4)
...
run('http://www.columbiadailyherald.com/calendar?/event/8297609/52647469/adult-board-game-night')
